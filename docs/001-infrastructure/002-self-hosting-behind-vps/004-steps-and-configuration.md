...
Pangolin and its associated services (Gerbil and Traefik) should be updated periodically to receive bug fixes, security patches, and new features. The update process involves stopping the Docker stack, updating version numbers, pulling new images, and restarting the services, as per the following steps:
...
:::info
    For troubleshooting common issues and additional support, please refer to the [Troubleshooting](./troubleshooting) section.
:::
